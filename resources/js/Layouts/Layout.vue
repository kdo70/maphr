    ...
    >
        <div class="relative flex items-center justify-between">
            ...
            >
                ...
                id="test">Company name</span
                >
            </link>
            <ul class="flex items-center hidden space-x-8 lg:flex">
                <li>

                    <Link :href="route('home')" aria-label="Our product"
                          title="Our product"
                          class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">home</Link>
                </li>
                <li>
                    <Link :href="route('test')" aria-label="Our product"
                          title="Our product"
                          class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">test</Link>
                </li>
                <li>
                    <a
                        href="/"
                ...
                <li>
                    <a
                        href="/"
                        class=" inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-rose-700 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                        aria-label="Sign up"
                        title="Sign up"
                    >
                        Sign up
...
export default {
    ...
    mounted(){
        ...
        window.Echo.channel('public').listen('Hello',(e)=>{
            ...
            let fontsDiv = document.getElementById("test");
            fontsDiv.innerHTML = e.name;
            console.log('go public');
            //code for displaying the serve data
            console.log(e.name); // the data from the server
        })
    }
};
